export const perguntas = [
    {
        enunciado: "Você chegou no último ano do ensino médio, e percebe que seu tempo de colegial está prestes a se findar. Qual é seu pensamento sobre isso?",
        alternativas: [
            {
                texto: "Isso é assustador!",
                afirmacao: [
                    "Está com medo do que está por vir.",
                    "Achou assustador como o tempo passou rápido."
                ],
                proxima: 1,
            },
            {
                ...
                afirmacao: [
                    "Refletiu sobre sua dedicação e esforço, e está contente por estar encerrando um lindo ciclo de sua vida.",
                    "Pensou em como boas escolhas levam à boas conquistas."
                ],
                proxima: 2,
            },
        ]
    ...
    {
        enunciado: "Decidir sobre qual carreira profissonal seguir é um fato aterrorizante. Diante disso uma professora propôs um teste vocacional para os seus alunos ?",
        alternativas: [
            {
                texto: "Utiliza-se uma plataforma que se permite contar um pouco de sua história, como foram seus anos como aluno e também hobbies pessoais.",
                afirmacao: [
                    "Com êxito respondeu todas as questões com facilidade.",
                    "Sentiu-se confiante e pronto para fazer boas escolhas.",
                    "Percebeu que seja qual for a carreira escolhida, será bem sucedido pois tem conviccção de um futuro promissor."
                ],
                proxima: 3,
            },
            {
                texto: "Não usou nenhuma plataforma para descobrir seus interesses e pensar sobre possíveis carreiras.",
                afirmacao: [
                    "Sentiu-se confortável em não pensar sobre isso agora.",
                    "Achou que a melhor opção é esperar pelo final do ano letivo.",
                    "Sentiu-se confuso e inseguro em relação as respostas que formulou."
                ],
                proxima: 4,
            },
        ]
